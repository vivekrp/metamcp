...
description: "Connect MetaMCP with Open WebUI to provide aggregated MCP tools to your AI models"
---

Connect MetaMCP with Open WebUI to provide your AI models with aggregated MCP tools through OpenAPI endpoints.
