...
<AccordionGroup>
  ...
  <Accordion icon="cog" title="Configure Environment">
  ...
  <Accordion icon="docker" title="Start with Docker Compose">
    ...
    This will start:
    - MetaMCP frontend (Next.js)
    - MetaMCP backend (Express.js + tRPC)
    - PostgreSQL database
    
    <Tip>
      The first startup may take a few minutes as Docker images are downloaded and built.
    </Tip>
  </Accordion>
</AccordionGroup>
