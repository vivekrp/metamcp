...
<CardGroup cols={2}>
  ...
  <Card title="Enhanced Inspector" icon="magnifying-glass-chart">
    Use as enhanced MCP inspector with saved server configs, and inspect your MetaMCP endpoints.
  </Card>
  <Card title="Context Engineering Engine for MCP" icon="magnifying-glass">
...
<CardGroup cols={3}>
  <Card title="Cursor" icon="laptop-code" href="/integrations/cursor">
